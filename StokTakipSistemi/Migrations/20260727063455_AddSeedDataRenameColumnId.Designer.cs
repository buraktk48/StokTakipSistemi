...
namespace StokTakipSistemi.Migrations
{
    ...
    [Migration("20260727063455_AddSeedDataRenameColumnId")]
    partial class AddSeedDataRenameColumnId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StokTakipSistemi.Entities.Depo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ad = "Ana Depo",
                            lokasyon = "Merkez",
                            olusturulma_zamani = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
