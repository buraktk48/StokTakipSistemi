            ...
            modelBuilder.Entity("StokTakipSistemi.Entities.Depo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ad = "Ana Depo",
                            lokasyon = "Merkez",
                            olusturulma_zamani = new DateTime(2026, 7, 28, 15, 52, 54, 898, DateTimeKind.Local).AddTicks(8939)
                        });
                });
            ...
            modelBuilder.Entity("StokTakipSistemi.Entities.Kullanici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            olusturulma_zamani = new DateTime(2026, 7, 28, 15, 52, 54, 898, DateTimeKind.Local).AddTicks(8924),
                            rol_id = 1,
                            sifre = "123456",
                            soyad = "Hesap"
                        });
            ...
            modelBuilder.Entity("StokTakipSistemi.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1,
                            adi = "Admin",
                            olusturulma_zamani = new DateTime(2026, 7, 28, 15, 52, 54, 898, DateTimeKind.Local).AddTicks(8833)
                        },
                        new
                        {
                            id = 2,
                            adi = "Personel",
                            olusturulma_zamani = new DateTime(2026, 7, 28, 15, 52, 54, 898, DateTimeKind.Local).AddTicks(8844)
                        });
                });
